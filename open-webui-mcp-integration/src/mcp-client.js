...
export class MCPClient extends EventEmitter {
    ...
    constructor(serverId, serverEndpoint, protocol = 'sse') {
        super();
        this.serverId = serverId;
        this.serverEndpoint = serverEndpoint;
        this.protocol = protocol;
    }
    async connect(authentication) {
        if (this.isConnected) {
            return;
        }
        try {
    ...
    async connectSSE(authentication) {
        const headers = {
    ...
    async connectWebSocket(authentication) {
        return new Promise((resolve, reject) => {
    ...
    async connectStdio(authentication) {
    ...
    addAuthHeaders(headers, authentication) {
